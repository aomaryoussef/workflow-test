...
logger = logger.bind(service="registry", context="controller", action="create B.Tech payment")


class CreateBTechPaymentController(BaseController):
    def __init__(self, request):
        ...
        self.input_dto: InputDto = InputDto(
            ...
            billing_account_schedule_id=request.json["loan_scheduel_id"],
