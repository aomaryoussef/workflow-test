...
type GeneralJournalEndOfDayAggregatesRequest struct {
	DayStart             string                    `json:"date_range_start" mapstructure:"date_range_start"`
	DayEnd               string                    `json:"date_range_end" mapstructure:"date_range_end"`
...
type AccountBalanceLine struct {
...
type TransactionTypeLine struct {
	...
	Changes []AccountBalanceLine `json:"changes" mapstructure:"changes"`
}
