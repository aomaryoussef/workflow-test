...
func (c *Commands) ApproveFinancialProduct(ctx context.Context, cmd *types.ApproveFinancialProductCmd) (*types.CmdProcessorResult, error) {
	log := logging.WithContext(ctx)
	ctx, span := otelx.NewSpanFromContext(ctx, "commands#ApproveFinancialProduct")
	defer span.End()
