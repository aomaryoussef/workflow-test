-- Model Data Sample
insert into models (id, name, type, version, features_names, features_dtypes, parameters, is_active, created_at)
...
-- Lookups Data Sample
insert into lookups (id, lookup_type, slug, name, description)
